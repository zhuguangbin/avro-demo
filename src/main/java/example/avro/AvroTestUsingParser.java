 ...
 */
public class AvroTestUsingParser {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      File avroSchemaFile = new File(workingDir.toString(),"/src/main/avro/user.avsc");
      schema = new Schema.Parser().parse(avroSchemaFile);
    } catch (IOException e) {
      System.err.println("Cannot find avro schema file");
      e.printStackTrace();
    }
